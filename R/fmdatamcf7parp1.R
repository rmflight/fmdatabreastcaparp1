...
#' MNase Nucleosome Data
#' 
#' MNase nucleosome signal from GM12878, generated by ENCODE, summed over 500 base
#' tiles of the genome.
#' 
#' @format Granges with an mcol called \code{nuc}, holding the summed signal over the
#' tile.
#' @name nuc_signal
#' @source \url{ftp://hgdownload.cse.ucsc.edu/goldenPath/hg19/encodeDCC/wgEncodeSydhNsome/wgEncodeSydhNsomeGm12878Sig.bigWig}
NULL
